...
In this [Jupyter notebook](https://github.com/microsoft/ai4eutils/blob/master/geospatial/notebooks/GEE_python_api.ipynb) we reproduce the same previously presented example using the GEE python API. 