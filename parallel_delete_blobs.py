...
if False:
    ...
    account_name = 'ai4edevshare'
    container_name = 'ai4edebug'
    sas_token_file = os.path.expanduser('~/tokens/ai4edevshare_ai4edebug_sas_tokens.txt')
    input_file = r'c:\temp\test_deletions.txt'
